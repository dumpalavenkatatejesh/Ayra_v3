...
const FocusCenters = () => {
    return (
        <>
            <div className="w-full my-10 border-none md:border-t-2 md:border-dashed" style={{ borderColor: '#A9B8D5' }}>
                <div className="container mx-auto p-4 lg:p-0">
                    <div className="flex flex-col md:flex-row lg:gap-8 gap-4">
                        ...
                        <div className="md:w-1/2 md:pr-8 relative lg:py-10">
                            ...
                            <div className="hidden md:block absolute top-0 right-0 h-full w-0.5" style={{ borderRight: '2px dashed #A9B8D5' }}></div>
                        </div>
                        {/* Right Side */}
                        <div className="md:w-1/2 lg:py-10">
                            <p className='text-[20px] font-tthoves-medium leading-tight'>
                                From entrepreneurship to wellness, AYRA&apos;s Focus Centres help you develop skills for life, not just for work.
                            </p>
                            <div>
                ...
                <div className="container mx-auto p-4 lg:p-0">
                    <Image src="/home/focus-centers.png" alt='focus centers' className='w-full' width={500} height={500} />
                </div>
            </div>
        </>
    )

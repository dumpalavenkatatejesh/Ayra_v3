      ...
      <div className="w-full flex flex-col-reverse md:flex-row">
        ...
        <div className="w-full md:w-1/2 bg-[#2050B1] text-white flex items-center justify-center ">
          <div className=" flex flex-col">
            ...
            <div className="mt-0 lg:mt-4 flex flex-col lg:gap-10 gap-5 lg:px-20 p-6">
              <div>
                <p className=" md:w-[70%] font-tthoves-light">
                  From student clubs to weekend treks, campus media labs to yoga
                  mornings—AYRA is where you’ll discover more than just
                  academics.
                </p>
              </div>
              <div>

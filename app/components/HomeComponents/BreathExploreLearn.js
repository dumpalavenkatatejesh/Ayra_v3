    ...
    <>
      ...
      <div className="w-full flex flex-row justify-center items-end p-4 lg:p-0">
        <div className="container lg:w-[80%] text-center py-10">
          <p>
            AYRA is nestled in a lush, elevated landscape just outside
            Bengaluru—overlooking the Nandi Hills range to the southwest and
          ...
          <div className="flex md:flex-row flex-col justify-center items-center md:gap-10 gap-4 mt-5">
            <div className="group inline-block">
              <button className="relative px-5 py-1 bg-[#66A4F9] group-hover:bg-[#7db1fa] text-white overflow-hidden cursor-pointer transition-colors duration-300 w-60">

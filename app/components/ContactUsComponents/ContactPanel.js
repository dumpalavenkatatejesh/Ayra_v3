...
const ContactPanel = () => {
  return (
       ...
       <div className="w-full lg:w-2/3 bg-[#0D2556] text-white mt-10 lg:mt-10 lg:p-20 p-5 space-y-8 ">
        {/* Email Us */}
        <div>
          <h3 className="text-3xl font-tthoves-demibold text-blue-300 mb-2">EMAIL US</h3>
        ...
        {/* Call Us */}
        <div>
          <h3 className="text-3xl font-tthoves-demibold text-blue-300 mb-2">CALL US</h3>
          <p className="text-md text-[#D7DEEB]">
        ...
        {/* Visit Us */}
        <div>
          <h3 className="text-3xl font-tthoves-demibold text-blue-300 mb-2">VISIT US</h3>
          <p className="text-md text-[#D7DEEB]">

    ...
    <div className="">
      <div className="border-b-2 border-dashed border-[#D0E3FF] mb-10">
        <div className="relative w-full h-[500px] md:h-[600px] lg:h-[700px] max-w-7xl mx-auto my-4">
          ...
          <div className="absolute lg:bottom-10 bottom-0 lg:left-[55%] left-[0%] flex items-center">
            <div className=" text-white p-10">
              <p className="border-b border-[#FFFFFF] border-dashed py-5">
                AYRA welcomes students from diverse academic backgrounds who are
                driven, creative, and ready to explore new possibilities. We offer
                undergraduate, postgraduate, and specialised programs tailored to
                industry needs.
              </p>
              ...
              <p>
                ...
                students in achieving their goals. Learn more about financial aid
                options.
              </p>
              {/* <div className="pt-5">
              ...
              <div>
            <button
              className="relative text-white font-bold px-5 py-1 w-36 bg-[#66A4F9] transition-all cursor-pointer group hover:shadow-inner border-dashed"
        ...
        <div className="container mx-auto p-5 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-[#2050B1] text-3xl font-tthoves-bold">Our admissions team is here to assist you.</p>
          <p className="text-[#002561] text-md">Contact us for guidance on the application process.</p>
        </div>
      </div>
    </div>
  );

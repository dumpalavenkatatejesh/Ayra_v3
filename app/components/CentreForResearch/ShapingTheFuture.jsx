    ...
    <div className="py-10 bg-[#002561] mt-5">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-5 flex flex-col items-center gap-4 text-white max-w-screen-lg mx-auto">
          <p className="sub-heading text-center px-2 sm:px-4 font-tthoves-extralight">
          ...
          <p className="cards-heading font-tthoves-medium text-center w-full sm:w-4/5 px-4">

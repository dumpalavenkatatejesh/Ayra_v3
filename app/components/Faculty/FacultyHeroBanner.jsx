  ...
  return (
    <>
      ...
      <div className="container mx-auto py-5 md:pt-8 px-4 md:px-0">
        <p className="text-large text-black font-light w-full md:w-11/12 font-tthoves-extralight">
        ...
        <p className="text-large text-black font-light w-full md:w-11/12 font-tthoves-extralight mt-4">
